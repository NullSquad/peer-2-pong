...
export function Phase1({ match, refresh }) {
	...
	return (
		<div className="relative flex flex-col w-full overflow-visible bg-invisible">
			...
			<div
				className={`animation-opacity ${showPhase2
	...
	return (
		<div className="z-10 relative flex w-full overflow-visible bg-invisible">
			<div className="relative flex w-full h-[75%] -skew-x-[8deg]">
				{/* Blue Card */}
				<div className="relative flex items-center justify-between bg-accent-blue-light w-5/12 px-2 py-2 text-black">
					{/* Blue image */}
				...
				{/* Red Card */}
				<div className="relative flex items-center justify-between bg-red-500 w-9/12 px-2 py-2 text-black">
					{/* Red score */}
	...
	return (
		<div className="z-10 relative flex flex-col w-full overflow-visible bg-invisible">
			<div className="relative flex w-full h-[75%] -skew-x-[8deg]">
				...
				{/* Player 2 Side */}
				<div className="relative grid grid-cols-[auto_1fr] items-center bg-red-500 w-1/2 px-2 text-black">
					<div classname="flex items-center">
						<PlayerScore score={match.players[1].score} skew="skew-x-[8deg]" />
					</div>
					<div className="flex justify-center items-center">
...
export function Phase5({ match }) {
	...
	const winner = match.players[0].score > match.players[1].score ? "blue" : "red";
	...
	return (
		<div className="z-10 relative flex w-full overflow-visible bg-invisible">
			<div className="relative flex w-full h-[75%] -skew-x-[8deg]">
				...
				{/* Blue Card */}
				<div className={`relative grid grid-cols-[1fr_auto] items-center bg-accent-blue-light ${blueCardSize} px-2 text-black`}>
					...
					<div className="skew-x-[8deg] bg-black text-white p-1 px-2 rounded w-5 h-6 sm:w-7 sm:h-8 flex items-center justify-center">
				...
				{/* Red Card */}
				<div className={`relative grid grid-cols-[auto_1fr] items-center bg-red-500 ${redCardSize} px-2 text-black`}>
					<div className="skew-x-[8deg] bg-black text-white p-1 px-2 rounded w-5 h-6 sm:w-7 sm:h-8 flex items-center justify-center">
