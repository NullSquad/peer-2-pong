...
export function Phase5({ match }) {
  ...
  const winner =
    match.players[0].score > match.players[1].score ? "blue" : "red";
  ...
  return (
    <div className="z-10 relative flex w-full overflow-visible bg-invisible">
      <div className="relative flex w-full h-[75%] -skew-x-[8deg]">
        {/* Blue Card */}
        <div
          className={`relative grid grid-cols-[1fr_auto] items-center bg-accent-blue-light ${blueCardSize} px-2 text-black`}
        >
        ...
        {/* Red Card */}
        <div
          className={`relative grid grid-cols-[auto_1fr] items-center bg-red-500 ${redCardSize} px-2 text-black`}
        >
          <div className="skew-x-[8deg] bg-black text-white p-1 px-2 rounded w-5 h-6 sm:w-7 sm:h-8 flex items-center justify-center">
