    ...
    <div className="relative flex w-full max-w-4xl h-[86px] sm:h-[94px] md:h-28 overflow-visible bg-gray-800">
      ...
      <div className="relative flex w-full h-14 sm:h-16 -skew-x-[8deg]">
        ...
        <div className="relative flex items-center justify-center bg-accent-blue-light w-1/2 px-3 py-2 text-black">
          ...
          <div
            className="absolute top-1/2 right-4 -translate-y-1/2 skew-x-[8deg] bg-black text-white p-1 px-2 rounded w-6 h-7 sm:w-7 sm:h-8 flex items-center justify-center"
          >
        ...
        <div className="relative flex items-center justify-center bg-accent-red-light w-1/2 px-3 py-2 text-black">
          ...
          <div
            className="absolute top-1/2 left-4 -translate-y-1/2 skew-x-[8deg] bg-black text-white p-1 px-2 rounded w-6 h-7 sm:w-7 sm:h-8 flex items-center justify-center"
          >
