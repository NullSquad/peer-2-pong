...
return (
	<header className="relative mt-6 mb-10">
		...
		<div 
			className="absolute z-20 bg-yellow-500 text-white sm:mt-15 py-1 px-5 sm:px-10 sm:ml-[-1%] ml-[-2%] w-[50%] sm:w-[42%] xl:w-[23%] flex justify-end
			...
			<h2 className="text-xl sm:text-3xl font-bold skew-x-[8deg] border-text-black text-stroke">
		...
		></div>
		<div 
			className="relative z-0 bg-yellow-500 text-white py-1.5 px-5 sm:px-10 sm:ml-[-1%] ml-[-2%] w-[65%] sm:w-[50%] xl:w-[30%] flex justify-between 
			items-center border-t-[8px] border-t-yellow-50 border-b-[8px] border-b-yellow-700 border-r-[4px] border-r-black shadow-md transform -skew-x-[8deg]"
		></div>
	</header>
);};
