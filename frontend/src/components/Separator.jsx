...
return (
	...
	<div 
		className="absolute z-20 bg-yellow-500 text-white sm:mt-15 py-1 px-5 sm:px-10 sm:ml-[-1%] ml-[-2%] w-[60%] sm:w-[30%] lg:w-[20%] flex justify-end
	...
	<div 
		className="relative z-10 bg-yellow-500 text-white py-1.5 px-5 sm:px-10 sm:ml-[-1%] ml-[-2%] w-[90%] sm:w-[50%] lg:w-[40%] flex justify-between 
	...
	></div>
	<div 
		className="relative z-0 bg-yellow-500 text-white py-1.5 px-5 sm:px-10 sm:ml-[-1%] ml-[-2%] w-[75%] sm:w-[40%] lg:w-[30%] flex justify-between 
		items-center border-t-[8px] border-t-yellow-50 border-b-[8px] border-b-yellow-700 border-r-[4px] border-r-black shadow-md transform -skew-x-[8deg]"
	></div>
	</header>
);
