      ...
      <td className="align-middle justify-center py-1 w-[30%]">
        <span
          className={`inline-block w-[1.3em] h-[1.3em] sm:w-[1.5em] sm:h-[1.5em] items-center justify-center
              ...
              index == 0
                ? "bg-yellow-400 rounded-full border-[0.5px] border-black"
                : index == 1
                  ? "bg-gray-300 rounded-full border-[0.5px] border-black"
                  : index == 2
                    ? "bg-yellow-700 rounded-full border-[0.5px] border-black"
                    : ""
            }`}
        >
          {index + 1}
