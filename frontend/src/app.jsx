		...
		<>
			<div className="w-[200px] h-[70px] left-[96px] top-[575px] absolute justify-center items-center inline-flex">
				<div className="w-[200px] h-[70px] relative">
					<div className="w-[199.99px] h-[69.72px] shadow-inner-top-[myred] px-4 py-2 left-0 top-[0.28px] absolute bg-yellow-500 rounded-sm border-2 border-black justify-center items-center gap-2 inline-flex">
